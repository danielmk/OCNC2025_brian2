...
if __name__ == '__main__':
    ...
    e_syn = b2.Synapses(exc_input, neuron, model=excitatory_synapse_model_string, on_pre='g += weight')
    
    e_syn.connect(p=0.1)
    
    e_syn.tau_inact = 20 * b2.ms
    
    i_syn = b2.Synapses(inh_input, neuron, model=inhibitory_synapse_model_string, on_pre='g += weight')
