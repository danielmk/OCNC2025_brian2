...
void _run_inh_synapses_pre_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_inh_synapses_delay.size();
    ...
    {
        inh_synapses_pre.advance();
        inh_synapses_pre.push(_ptr_array_inh_neurons__spikespace, _ptr_array_inh_neurons__spikespace[_num_spikespace-1]);
    }
