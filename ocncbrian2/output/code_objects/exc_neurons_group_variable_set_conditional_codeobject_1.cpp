...
const double _lio_statement_1 = 196.0 * pA;
const double _lio_statement_2 = 20.0 * pA;
...
for(int _idx=0; _idx<_N; _idx++)
{
    ...
    if (_cond)
    {
        ...
        double I;
        I = _lio_statement_1 + (_lio_statement_2 * _rand(_vectorisation_idx));
        _ptr_array_exc_neurons_I[_idx] = I;
