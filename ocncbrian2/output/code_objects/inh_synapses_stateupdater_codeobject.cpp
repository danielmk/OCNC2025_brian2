...
double* const _array_inh_synapses_tau_inact = _dynamic_array_inh_synapses_tau_inact.empty()? 0 : &_dynamic_array_inh_synapses_tau_inact[0];
const size_t _numtau_inact = _dynamic_array_inh_synapses_tau_inact.size();
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_inh_synapses_N = _array_inh_synapses_N;
    double*   _ptr_array_inh_synapses_clock_dt = _array_inh_synapses_clock_dt;
    double* __restrict  _ptr_array_inh_synapses_g = _array_inh_synapses_g;
    double* __restrict  _ptr_array_inh_synapses_tau_inact = _array_inh_synapses_tau_inact;
    ...
    const double dt = _ptr_array_inh_synapses_clock_dt[0];
    const double _lio_1 = - dt;


    const int _N = _array_inh_synapses_N[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double tau_inact = _ptr_array_inh_synapses_tau_inact[_idx];
