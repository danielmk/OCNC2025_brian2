...
const size_t _numdelay = _dynamic_array_exc_recurrent_synapses_delay.size();
    ...
    {
        exc_recurrent_synapses_pre.advance();
        exc_recurrent_synapses_pre.push(_ptr_array_exc_neurons__spikespace, _ptr_array_exc_neurons__spikespace[_num_spikespace-1]);
    }
