...
double* const _array_exc_feedback_synapses_g = _dynamic_array_exc_feedback_synapses_g.empty()? 0 : &_dynamic_array_exc_feedback_synapses_g[0];
const size_t _numg = _dynamic_array_exc_feedback_synapses_g.size();
double* const _array_exc_feedback_synapses_weight = _dynamic_array_exc_feedback_synapses_weight.empty()? 0 : &_dynamic_array_exc_feedback_synapses_weight[0];
const size_t _numweight = _dynamic_array_exc_feedback_synapses_weight.size();
    ///// POINTERS ////////////
        
    int32_t* __restrict  _ptr_array_exc_feedback_synapses__synaptic_pre = _array_exc_feedback_synapses__synaptic_pre;
    double* __restrict  _ptr_array_exc_feedback_synapses_g = _array_exc_feedback_synapses_g;
    double* __restrict  _ptr_array_exc_feedback_synapses_weight = _array_exc_feedback_synapses_weight;
    ...
    {
    std::vector<int> *_spiking_synapses = exc_feedback_synapses_pre.peek();
        ...
        _spiking_synapse_idx++)
    {
        ...
        double g = _ptr_array_exc_feedback_synapses_g[_idx];
        const double weight = _ptr_array_exc_feedback_synapses_weight[_idx];
        g += weight;
        _ptr_array_exc_feedback_synapses_g[_idx] = g;
...
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_exc_feedback_synapses__synaptic_pre.size() << endl;
}
