...
const size_t _numgi_post = 500;
const size_t _num_postsynaptic_idx = _dynamic_array_inh_synapses__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    {
        _ptr_array_exc_neurons_gi[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_inh_synapses_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const double g = _ptr_array_inh_synapses_g[_idx];
        const double _synaptic_var = g;

        _ptr_array_exc_neurons_gi[_ptr_array_inh_synapses__synaptic_post[_idx]] += _synaptic_var;
    }
