...
void _run_exc_neurons_spike_resetter_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const int64_t N = 500;
const size_t _numVr = 500;
const size_t _num_spikespace = 501;
const size_t _numb = 500;
...
const size_t _numw = 500;
	...
	const int32_t *_events = _ptr_array_exc_neurons__spikespace;
	const int32_t _num_events = _ptr_array_exc_neurons__spikespace[N];
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        const double Vr = _ptr_array_exc_neurons_Vr[_idx];
        const double b = _ptr_array_exc_neurons_b[_idx];
