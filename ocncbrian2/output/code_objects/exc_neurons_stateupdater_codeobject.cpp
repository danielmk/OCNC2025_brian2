...
void _run_exc_neurons_stateupdater_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const size_t _numC = 500;
const size_t _numDeltaT = 500;
const size_t _numEEx = 500;
const size_t _numEIn = 500;
const size_t _numEL = 500;
const size_t _numI = 500;
const int64_t N = 500;
const size_t _numVT = 500;
const size_t _numa = 500;
const size_t _numdt = 1;
const size_t _numgL = 500;
const size_t _numge = 500;
const size_t _numgi = 500;
const size_t _numtau_w = 500;
const size_t _numv = 500;
const size_t _numw = 500;
    ///// POINTERS ////////////
    ...
    double*   _ptr_array_exc_neurons_clock_dt = _array_exc_neurons_clock_dt;
    ...
    const double dt = _ptr_array_exc_neurons_clock_dt[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double C = _ptr_array_exc_neurons_C[_idx];
        const double DeltaT = _ptr_array_exc_neurons_DeltaT[_idx];
        const double EEx = _ptr_array_exc_neurons_EEx[_idx];
        const double EIn = _ptr_array_exc_neurons_EIn[_idx];
        const double EL = _ptr_array_exc_neurons_EL[_idx];
        const double I = _ptr_array_exc_neurons_I[_idx];
        const double VT = _ptr_array_exc_neurons_VT[_idx];
        const double a = _ptr_array_exc_neurons_a[_idx];
        const double gL = _ptr_array_exc_neurons_gL[_idx];
        const double ge = _ptr_array_exc_neurons_ge[_idx];
        const double gi = _ptr_array_exc_neurons_gi[_idx];
        const double tau_w = _ptr_array_exc_neurons_tau_w[_idx];
        double v = _ptr_array_exc_neurons_v[_idx];
        double w = _ptr_array_exc_neurons_w[_idx];
        ...
        v = _v;
        w = _w;
        _ptr_array_exc_neurons_v[_idx] = v;
        _ptr_array_exc_neurons_w[_idx] = w;
