...
void _run_exc_recurrent_synapses_stateupdater_codeobject()
{
...
const size_t _numtau_inact = _dynamic_array_exc_recurrent_synapses_tau_inact.size();
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_exc_recurrent_synapses_N = _array_exc_recurrent_synapses_N;
    double*   _ptr_array_exc_recurrent_synapses_clock_dt = _array_exc_recurrent_synapses_clock_dt;
    ...
    const double dt = _ptr_array_exc_recurrent_synapses_clock_dt[0];
    const double _lio_1 = - dt;


    const int _N = _array_exc_recurrent_synapses_N[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double tau_inact = _ptr_array_exc_recurrent_synapses_tau_inact[_idx];
