...
void _run_inh_neurons_spike_resetter_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const int64_t N = 100;
const size_t _numVr = 100;
const size_t _num_spikespace = 101;
const size_t _numb = 100;
...
const size_t _numw = 100;
	...
	const int32_t *_events = _ptr_array_inh_neurons__spikespace;
	const int32_t _num_events = _ptr_array_inh_neurons__spikespace[N];
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        const double Vr = _ptr_array_inh_neurons_Vr[_idx];
        const double b = _ptr_array_inh_neurons_b[_idx];
