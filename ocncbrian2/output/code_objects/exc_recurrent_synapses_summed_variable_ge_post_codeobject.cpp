...
const size_t _numge_post = 500;
const size_t _num_postsynaptic_idx = _dynamic_array_exc_recurrent_synapses__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    {
        _ptr_array_exc_neurons_ge[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_exc_recurrent_synapses_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const double g = _ptr_array_exc_recurrent_synapses_g[_idx];
        const double _synaptic_var = g;

        _ptr_array_exc_neurons_ge[_ptr_array_exc_recurrent_synapses__synaptic_post[_idx]] += _synaptic_var;
    }
